...
void employee::set_datafile_name(char *name){
...
void employee::edit_rec(){
    ...
    cout<<"\nEnter Record Number to be edited: ";       // can be vastly improved here
                                                        ...
                                                        // add search by name and or employee _id_
    cin>>n;
